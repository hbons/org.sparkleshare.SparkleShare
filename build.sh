...
xdg-app-builder --repo=sparkleshare.bitbucket.org --gpg-sign=051F66BD app org.sparkleshare.SparkleShare.json
xdg-app --user uninstall org.sparkleshare.SparkleShare
xdg-app --user remote-delete sparkleshare
xdg-app --user remote-add --gpg-import=sparkleshare.gpg sparkleshare ./sparkleshare.bitbucket.org/
